...
1. AI-powered & open source tools for finding papers
  ...
  * Paper recommendations & networks: **ResearchRabbit**
...
### [Elicit](www.elicit.org)
  ...
  * Check the part of the paper describing the feature
]
...
```
* Overleaf & Latex: Exporting BibTex citations (automate with Better BibTex Add-on)
]
.pull-right[.center-right[
...
## Literature search workflow (Exercise)
...
3. Sync the collection with [ResearchRabbit](www.researchrabbit.com)
