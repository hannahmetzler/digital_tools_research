...
.pull-right[
* [Peer Community In](https://peercommunityin.org/) & [PCI RR](https://rr.peercommunityin.org/)
* free meta-journal platform & community
* reviews & recommends pre-prints RRs since 2022 
* Journals justify fees with added value of editing/review
* Brings value of peer-review back to community
* Publishing in [PCI friendly journals](https://rr.peercommunityin.org/about/pci_rr_friendly_journals)
]
...
* Check if some journals in your discipline are listed on the [TOP factor](https://topfactor.org/journals/) ranking